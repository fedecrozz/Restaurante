...
public class ArticuloDeliveryNuevo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ArticuloDeliveryNuevo frame = new ArticuloDeliveryNuevo(null, null);
	 ...
	 * Create the frame.
	 */
	public ArticuloDeliveryNuevo(ArticulosDelivery articulos, Conector con) {
		a = articulos;
	...
	public void iniciarCodigo() {
		con.conectar();
		String ultimo = con.getCodigoUltimoArticuloDelivery();
		con.cerrarConexion();
	...
	public void guardarArticulo() {
		...
		con.conectar();
		boolean existe = con.existeArticuloDelivery(String.valueOf(Articulo));
		con.cerrarConexion();
