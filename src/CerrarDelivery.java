...
public class CerrarDelivery extends JFrame {
	...
	public void iniciarValores() {
		...
		String[] columnNames = {"Valor", "Monto", "Acci�n"};
        ...
        int rowHeight = 50; // Altura en p�xeles
   ...
   class ButtonRenderer extends JButton implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        setText("Todo " + nombre); // Concatenar el nombre en el texto del bot�n
        
        // Verificar si hay texto en la segunda columna
        String monto = (String) table.getValueAt(row, 1);
        if (monto != null && !monto.isEmpty()) {
            setEnabled(false); // Deshabilitar el bot�n si hay texto en la segunda columna
        } else {
            setEnabled(true); // Habilitar el bot�n si no hay texto en la segunda columna
        }
    ...
    class ButtonEditor extends DefaultCellEditor {
        ...
        public ButtonEditor(JCheckBox checkBox) {
            ...
            // Agregar ActionListener para responder a los clics en el bot�n
            button.addActionListener(new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent e) {
                    fireEditingStopped();
                    // Ejecutar el m�todo correspondiente al bot�n clickeado
        ...
        public Component getTableCellEditorComponent(JTable table, Object value, boolean isSelected, int row, int column) {
            ...
            String monto = (String) table.getValueAt(row, 1);
            if (monto != null && !monto.isEmpty()) {
                button.setEnabled(false); // Deshabilitar el bot�n si hay texto en la segunda columna
            } else {
                button.setEnabled(true); // Habilitar el bot�n si no hay texto en la segunda columna
            }
        ...
        public Object getCellEditorValue() {
            if (clicked) {
                // Si se hizo clic en el bot�n
                return label;
            } else {
                // Si no se hizo clic en el bot�n
                return null;
            }
        }
    ...
    public String limitarLongitud(String texto,int longitud) {
        if (texto.length() >= longitud) {
            return texto.substring(0, longitud); // Limitar el tama�o a 30 caracteres
        } else {
