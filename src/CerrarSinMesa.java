...
public class CerrarSinMesa extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CerrarSinMesa frame = new CerrarSinMesa(null,null);
	 ...
	 * Create the frame.
	 */
	public CerrarSinMesa(SinMesa sinMesa,MesaClase m) {
		Mesa = sinMesa;
		mesaClase = m ;
		setResizable(false);
