...
public class SinMesa extends JFrame {
...
//	private static GUI gui = new GUI();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SinMesa frame = new SinMesa(null,0);
    ...
    public static void iniciarArticulosMesa(int numeroMesa) {
    	...
    	con.conectar();
    	MesaClase m = con.getSinMesa(0);
    	con.cerrarConexion();
    	
    	con.conectar();
    	ArrayList<ArticuloMesa> articulos = con.getArticulosSinMesa(0);
    	con.cerrarConexion();
    ...
    public void cerrarMesa() {
    	...
    	if(input == 0) {
    		CerrarSinMesa c = new CerrarSinMesa(this,m);
    		c.setVisible(true);
    	}
